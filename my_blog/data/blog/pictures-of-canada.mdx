...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image loader={myLoader} alt="Maple" src="/static/images/canada/maple.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image loader={myLoader} alt="Lake" src="/static/images/canada/lake.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image loader={myLoader} alt="Mountains" src="/static/images/canada/mountains.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image loader={myLoader} alt="Toronto" src="/static/images/canada/toronto.jpg" width={640} height={427} />
  </div>
</div>
