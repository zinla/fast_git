      ...
      <div>
            <header className="site-header">
                <div className="logo-and-tagline">
                    ...
                    <a className="sr-only" href="./">Alen_Andry Blog</a>
                </div>
                <div>
            <li
            ...
            <input
                            ...
                            className="search"
                name="username"/>
            <a href="./search?q={{ search }}" className="jetpack-search-filter__link">
                <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
            ...
            <nav id="main-nav" className="main-nav mobile-is-closed">
                <ul>
                    <li className="main-nav-episodes"><a href="./rust">Rust Series</a></li>
                    <li className="main-nav-series"><a href="./backend">Backend Series</a></li>
                    <li className="main-nav-advertising">
                    <a href="./fontend_ml">Frontend ML Series</a>
                    </li>
                    <li className="main-nav-ask"><a href="./javascript">javascript Series</a></li>
                    <li className="main-nav-topics"><a href="./python">python Series</a></li>
                    <li className="main-nav-topics"><a href="./java">Java Series</a></li>
                    <li className="main-nav-ask"><a href="./vue">Vue Series</a></li>
                    <li className="main-nav-ask"><a href="./react">React Series</a></li>
                    <li className="main-nav-ask"><a href="./angular">Angular Series</a></li>
                    <li className="main-nav-ask"><a href="./git">Git Series</a></li>
                    <li className="main-nav-ask"><a href="./bash">Bash Series</a></li>
                    <li className="main-nav-ask"><a href="./data_structure">Data Structure</a></li>
                </ul>
            </nav>
            </div>
