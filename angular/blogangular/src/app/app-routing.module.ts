...
const routes: Routes = [
{ path: '87', component: FastWayToImplmentObjectTraitComponent },
{ path: '86', component: ListDirComponent },
  ...
  { path: '85', component: RustImplmentFindAndRemoveCliComponent },
  { path: '84', component: ClonalSelectionAlgorithmComponent },

  { path: '83', component: OptimizeRustCompilationBinarySizeComponent },


  { path: '82', component: MyCommandListComponent },



  { path: '81', component: ImplementTrieDataStructureComponent },




  { path: '80', component: PaseStringAndDecimalConversionComponent },





  { path: '79', component: WhereMyAnagramsAtComponent },
  ...
  { path: '78', component: UniqueEmailAddressesComponent },
  ...
  { path: '77', component: DiStringMatchComponent },
  ...
  { path: '76', component: MaximumDepthOfBinaryTreeComponent },
  ...
  { path: '75', component: FlippingAnImageComponent },
  ...
  { path: '73', component: NimGameComponent },
  ...
  { path: '72', component: SelfDividingNumbersComponent },
  ...
  { path: '74', component: HammingDistanceComponent },
